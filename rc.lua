...
local function set_wallpaper(s)
    -- Wallpaper
    awful.spawn.with_shell("feh --bg-scale ~/.config/awesome/wallpaper.png")
end
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "c",     function () awful.spawn("rofi -show run") end,
              {description = "run prompt", group = "launcher"}),
    awful.key({ modkey },            "r",     function () awful.spawn("rofi -show window") end,
              {description = "run windows", group = "launcher"})
)
